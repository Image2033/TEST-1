...
<head>
  ...
  <title>books.kg - Books 7th grade</title>
...
<?php require_once '../pages/assets/header.php'?>
    ...
    <div class="header-2" style="padding: 5px">
        <nav class="navbar">
            <div style="font-size: 25px; color: #fff;">Books 7th grade</div>
        </nav>
    </div>
  ...
  <div class="books-wrapper">
    <div class="books-content">
      <?php
        ...
        $books = mysqli_query($connect, "SELECT * FROM `books_7` WHERE `book_id` = ".$_GET['id']);
      ...
      <?php 
          ...
          while ($bks_7 = mysqli_fetch_assoc($books_7_query)) {
              ?>
                  ...
                  <a href="books-7.php?id=<?php echo $bks_7['book_id']?>" class="swiper-slide box" style="width: 410px;">
                      ...
                      <div class="content">
                          ...
                          <div class="price"><?php echo $bks_7['book_price']?> KGS</div>
                          <div class="stars">
                              <i class="fas fa-star"></i>
                              <i class="fas fa-star"></i>
                              <i class="fas fa-star"></i>
