...
<head>
  ...
  <title>books.kg - Books 6th grade</title>
...
<?php require_once '../pages/assets/header.php'?>
    ...
    <div class="header-2" style="padding: 5px">
        <nav class="navbar">
            <div style="font-size: 25px; color: #fff;">Books 6th grade</div>
        </nav>
    </div>
  ...
  <div class="books-wrapper">
    <div class="books-content">
      <?php
        ...
        $books = mysqli_query($connect, "SELECT * FROM `books_6` WHERE `book_id` = ".$_GET['id']);
      ...
      <?php 
          ...
          while ($bks_6 = mysqli_fetch_assoc($books_6_query)) {
              ?>
                  ...
                  <a href="books-6.php?id=<?php echo $bks_6['book_id']?>" class="swiper-slide box" style="width: 410px;">
                      ...
                      <div class="content">
                          ...
                          <div class="price"><?php echo $bks_6['book_price']?> KGS</div>
                          <div class="stars">
                              <i class="fas fa-star"></i>
                              <i class="fas fa-star"></i>
                              <i class="fas fa-star"></i>
